...
describe('UI Tests Epam', () => {
    ...
    it('Verify the policies list items', () => {
        ...
        //TODO ще як варіант (не обов'язково) можна спочатку перевірити, що список цих айтемів має довжину 6) - ❓Цей блок розділений на 2 списки - ul policies-left та ul policies-right - не впевнена як тут перевірити довжину
        homePage
